...
<head>
  ...
  <link rel="stylesheet" href="/css/softwareng.css" />
</head>
...
<div class="frame">
  <div class="piece output">
    ...
    <b>Languages</b> used were <strong> HTML,JS,Python </strong> and <b> framework</b> used was <strong>Flask for Python</strong>.<br>
    ...
    <b>Languages</b> used were <strong> Java</strong>.<br>
    ...
    <b>Languages</b> used were <strong> HTML,JS,PHP,SQL </strong> and <b> technologies</b> used were <strong>MariaDB Database,Herokuapp</strong>.<br>
    ...
    <p>This particular website has been a personal project running since December 2017. It has been an incredible learning experience because of the 
      ...
      <br>There is also a mail server running which required tinkering around with Apache configuration , nameservers and virtual hosts but it was a
      very rewarding experience and now I have my own <a href="mailto:enrico@enricozl.me">Email!</a> <br><br>
    <b>Languages</b> used were <strong> HTML, JS, PHP, SQL, Python, Bash </strong> and <b> technologies</b> used were <strong>Linux Architecture, Apache, Nginx, Nameservers, Mailserver, Webserver, Fileserver, Vue.js, Node.js, Nuxt.js</strong>.<br>
