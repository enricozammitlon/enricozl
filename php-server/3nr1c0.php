...
$auth_users = array(
    '3nr1c0' => '5c776a2a17ebd787b79934cf2be40c71' //admin
...
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        <div class="path login-form">
                <img src="/img/enrico-login.jpg" alt="Me" style="height:250px;">
            <form action="" method="post">
                ...
                <a href="/"><button class="input-like-button" type="button"> Go to homepage...</button></a>
