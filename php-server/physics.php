...
<div class="modules">
	...
	<h1>Physics</h1>
	<h4>I am currently in my third year of studies in (MPhys) Physics with Theoretical Physics. The following are the modules I have attended at university.</h4>
	<table class="rwd-table">
	  ...
	  <tr>
	    ...
	    <td data-th="Name">Fund. of Artificial Intelligence</td>
	    <td data-th="Year">1</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">MATH 20122</td>
	    <td data-th="Name">Metric Spaces</td>
	    <td data-th="Year">2</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 10071</td>
	    <td data-th="Name">Mathematics 1</td>
	    <td data-th="Year">1</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 10101</td>
	    <td data-th="Name">Dynamics</td>
	    <td data-th="Year">1</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 10121</td>
	    <td data-th="Name">Quantum Physics and Relativity</td>
	    <td data-th="Year">1</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 10191</td>
	    <td data-th="Name">Introduction to Astrophysics</td>
	    <td data-th="Year">1</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 10280</td>
	    <td data-th="Name">Year 1 Laboratory</td>
	    <td data-th="Year">1</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 10302</td>
	    <td data-th="Name">Vibrations and Waves</td>
	    <td data-th="Year">1</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 10342</td>
	    <td data-th="Name">Electricity & Magnetism</td>
	    <td data-th="Year">1</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 10352</td>
	    <td data-th="Name">Properties of Matter</td>
	    <td data-th="Year">1</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 10372</td>
	    <td data-th="Name">Mathematics 2</td>
	    <td data-th="Year">1</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 10471</td>
	    <td data-th="Name">Random Processes in Physics</td>
	    <td data-th="Year">1</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 10672</td>
	    <td data-th="Name">Advanced Dynamics</td>
	    <td data-th="Year">1</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 20040</td>
	    <td data-th="Name">General Paper I</td>
	    <td data-th="Year">2</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 20101</td>
	    <td data-th="Name">Intro. to Quantum Mechanics</td>
	    <td data-th="Year">2</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 20141</td>
	    <td data-th="Name">Electromagnetism</td>
	    <td data-th="Year">2</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 20161</td>
	    <td data-th="Name">Intro. to Programming for Physicists</td>
	    <td data-th="Year">2</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 20280</td>
	    <td data-th="Name">Year 2 Laboratory</td>
	    <td data-th="Year">2</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 20312</td>
	    <td data-th="Name">Wave Optics</td>
	    <td data-th="Year">2</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 20352</td>
	    <td data-th="Name">Thermal & Stat. Physics</td>
	    <td data-th="Year">2</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 20401</td>
	    <td data-th="Name">Lagrangian Dynamics</td>
	    <td data-th="Year">2</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 20672</td>
	    <td data-th="Name">Complex Vars. & Vector Spaces</td>
	    <td data-th="Year">2</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 20872</td>
	    <td data-th="Name">Theory Computing Project</td>
	    <td data-th="Year">2</td>
	  </tr>
	  <tr>
	    <td data-th="Module-ID">PHYS 20811</td>
	    <td data-th="Name">Professional Development</td>
	    <td data-th="Year">2</td>
	  </tr>		  
