          ...
          <div className="piece output">
            <div className="Menu">
              <p className="menu-line">
                ...
                <a href="https://www.linkedin.com/in/enricozammitl/" className="fa icon alt fa-linkedin">LinkedIn</a>
                <a href="https://github.com/enricozammitlon" className="fa icon alt fa-github">Github</a>
                <a href="https://gitlab.com/enricozammitlon" className="fa icon alt fa-gitlab">Gitlab</a>
              </p>
            </div>
            <Routes />
          </div>
